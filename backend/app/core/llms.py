...
llm = ChatLiteLLM(
    model="openrouter/deepseek/deepseek-chat-v3.1:free",   # este es el de pago, solo se cambiaría , pero usar solamente cuando sea necesario: "anthropic/claude-sonnet-4-20250514"
    temperature=0.1,
