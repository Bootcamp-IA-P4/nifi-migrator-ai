...
llm = ChatLiteLLM(
    model="anthropic/claude-sonnet-4-20250514",   # este es el de pago, solo se cambiaría , pero usar solamente cuando sea necesario: "anthropic/claude-sonnet-4-20250514"
    temperature=0.1,
